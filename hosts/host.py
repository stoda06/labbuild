...
apollo = Host(name="apollo", fqdn="apollo.rededucation.com", vcenter="vcenter-appliance-6.rededucation.com", resource_pool="cp-apollo", folder="cp")
nightbird = Host(name="nightbird", fqdn="nightbird.rededucation.com", vcenter="vcenter-appliance-6.rededucation.com", resource_pool="cp-nightbird", folder="cp")
ultramagnus = Host(name="ultramagnus", fqdn="ultramagnus.rededucation.com", vcenter="vcenter-appliance-6.rededucation.com", resource_pool="cp-ultramagnus", folder="cp")
